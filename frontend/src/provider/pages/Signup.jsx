    ...
    <div className="max-w-md mx-auto py-10">
      <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 space-y-6 shadow-2xl relative overflow-hidden">
        ...
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl font-black text-white">Apply as Barber Partner</h2>
          <p className="text-xs text-slate-400">Earn up to 300+ ILS/day cutting hair on demand</p>
        </div>
        ...
        <form className="space-y-4" onSubmit={handleSignup}>
          ...
          >
            ...
            <span>{loading ? 'Submitting Application...' : 'Apply & Join Platform'}</span>
          </button>
        </form>

        <div className="pt-2 border-t border-slate-800/80 text-center text-xs">
          <Link to="/provider/login" className="text-slate-400 hover:text-white transition-colors">
            Already registered as a provider? <strong className="text-amber-400">Log In</strong>
          </Link>
        </div>
      </div>
    </div>
