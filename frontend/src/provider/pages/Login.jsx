    ...
    <div className="max-w-md mx-auto py-10">
      <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 space-y-6 shadow-2xl relative overflow-hidden">
        ...
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl font-black text-white">Barber Partner Sign In</h2>
          <p className="text-xs text-slate-400">Access your dispatch console & receive haircut bookings</p>
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="w-full py-3 px-4 rounded-2xl bg-slate-950 border border-slate-800 hover:bg-slate-800 text-slate-200 font-bold text-xs flex items-center justify-center gap-3 shadow-md transition-all"
        >
          ...
          <span>Barber Sign In with Google</span>
        </button>

        <div className="relative flex items-center justify-center">
          <div className="border-t border-slate-800 w-full" />
          <span className="bg-slate-900 px-3 text-[10px] font-bold uppercase text-slate-500 shrink-0">
            or partner email
          </span>
          <div className="border-t border-slate-800 w-full" />
        </div>
        ...
        <form className="space-y-4" onSubmit={handleLogin}>
          <div className="space-y-1">
            <label className="text-xs font-bold text-slate-300 uppercase tracking-wider">Barber Email</label>
          ...
          >
            ...
            <span>{loading ? 'Logging in...' : 'Sign In as Barber'}</span>
          </button>
        </form>
        ...
        <div className="pt-2 border-t border-slate-800/80 flex flex-col gap-3 text-center text-xs">
          ...
          >
            ...
            <span>Autofill Demo Barber Credentials</span>
          </button>

          <Link to="/provider/signup" className="text-slate-400 hover:text-white transition-colors">
            Want to cut hair on DropIn? <strong className="text-amber-400">Apply to be a Provider</strong>
          </Link>
        </div>
      </div>
    </div>
