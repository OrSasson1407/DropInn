    ...
    <div className="max-w-md mx-auto py-10">
      <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 space-y-6 shadow-2xl relative overflow-hidden">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-400">Get fresh haircuts on demand anywhere in town</p>
        </div>
        ...
        <div className="pt-2 border-t border-slate-800/80 text-center text-xs">
          <Link to="/customer/login" className="text-slate-400 hover:text-white transition-colors">
            Already have an account? <strong className="text-amber-400">Log In</strong>
          </Link>
        </div>
      </div>
    </div>
